...
class KafkaAdminOnEC2Stack(cdk.Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        try:
            with open("stacks/back_end/kakfa_admin_on_ec2_stack/bootstrap_scripts/deploy_app.sh",
                      encoding="utf-8",
                      mode="r"
                      ) as f:
                user_data = f.read()
